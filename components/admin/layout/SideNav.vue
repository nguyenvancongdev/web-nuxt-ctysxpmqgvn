...
<template>
    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform">
        <NuxtLink to="/" class="flex items-center pb-4 border-b border-b-gray-800">

            <h2 class="font-bold text-2xl">PM<span class="bg-[#f84525] text-white px-2 rounded-md">QG</span></h2>
        </NuxtLink>
        <ul class="mt-4">
            ...
            <li class="mb-1 group">
                <NuxtLink to="/admin/about/image" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100 sidebar-dropdown-toggle">
                    <i class='bx bxl-blogger mr-3 text-lg' ></i>                 
